...
const nt=(t=>(...i)=>({_$litDirective$:t,values:i}))(class extends class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,i,e){this._$Ct=t,this._$AM=i,this._$Ci=e}_$AS(t,i){return this.update(t,i)}update(t,i){return this.render(...i)}}{constructor(t){var i;if(super(t),t.type!==st||"class"!==t.name||(null===(i=t.strings)||void 0===i?void 0:i.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((i=>t[i])).join(" ")+" "}update(t,[i]){var e,s;if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.et=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in i)i[t]&&!(null===(e=this.et)||void 0===e?void 0:e.has(t))&&this.st.add(t);return this.render(i)}const n=t.element.classList;this.st.forEach((t=>{t in i||(n.remove(t),this.st.delete(t))}));for(const t in i){const e=!!i[t];e===this.st.has(t)||(null===(s=this.et)||void 0===s?void 0:s.has(t))||(e?(n.add(t),this.st.add(t)):(n.remove(t),this.st.delete(t)))}return R}});class ot{constructor(t){this.cle=t}render(){const t=this.cle.titleText?N`<p class="legend-title">${this.cle.titleText}</p>`:"",i={hidden:"categorical"===this.cle.scaleType},e={hidden:"categorical"!==this.cle.scaleType,"categorical-container":!0};return N`<div
    ...
    >
      ...
      >
        ${t}
      </li>`))}`}renderContinuous(){var i,e;if("continuous"!==this.cle.scaleType||null===this.cle.colorScale)return"";const{colorScale:s,marginTop:n,marginLeft:o,marginRight:r,tickSize:l,width:h,range:c}=this.cle,a=this.cle.marginBottom+l,d=this.cle.height+l,u=(null===(e=(i=s).interpolator)||void 0===e?void 0:e.call(i))||t.piecewise(t.interpolateHcl,c);return M`<image 
      x=${o}
      y=${n}
      width=${h-r-o}
      height=${d-n-a}
...
`;var ut=function(t,i,e,s){for(var n,o=arguments.length,r=o<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,e):s,l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(i,e,r):n(i,e))||r);return o>3&&r&&Object.defineProperty(i,e,r),r};let vt=class extends Q{constructor(){super(...arguments),this.titleText="Color Legend Element",this.width=325,this.height=32,this.marginTop=6,this.marginRight=12,this.marginBottom=16,this.marginLeft=12,this.scaleType="continuous",this.domain=rt,this.range=lt,this.markType="circle",this.ticks=5,this.tickFormat=".1f",this.tickSize=6,this.tickValues=null,this.colorScaleSetter=new et(this),this.renderer=new ot(this),this.axisTickSetter=new at(this)}get interpolator(){return this._interpolator}set interpolator(t){if("function"!=typeof t)throw new Error("interpolator must be a function.");{const i=this.interpolator;this._interpolator=t,this.requestUpdate("interpolator",i)}}get tickFormatter(){return this._tickFormatter}set tickFormatter(t){if("function"!=typeof t)throw new Error("tickFormatter must be a function.");{const i=this.tickFormatter;this._tickFormatter=t,this.requestUpdate("tickFormatter",i)}}render(){return this.renderer.render()}willUpdate(t){ht.some((i=>t.has(i)))&&this.colorScaleSetter.setColorScale(),ct.some((i=>t.has(i)))&&(this.axisTickSetter.setXScale(),this.axisTickSetter.handleAxisTicks())}};vt.styles=[dt],ut([it({type:String})],vt.prototype,"titleText",void 0),ut([it({type:Number})],vt.prototype,"width",void 0),ut([it({type:Number})],vt.prototype,"height",void 0),ut([it({type:Number})],vt.prototype,"marginTop",void 0),ut([it({type:Number})],vt.prototype,"marginRight",void 0),ut([it({type:Number})],vt.prototype,"marginBottom",void 0),ut([it({type:Number})],vt.prototype,"marginLeft",void 0),ut([it({type:String})],vt.prototype,"scaleType",void 0),ut([it({type:Array})],vt.prototype,"domain",void 0),ut([it({type:Array})],vt.prototype,"range",void 0),ut([it({type:String})],vt.prototype,"markType",void 0),ut([it({type:Number})],vt.prototype,"ticks",void 0),ut([it({type:String})],vt.prototype,"tickFormat",void 0),ut([it({type:Number})],vt.prototype,"tickSize",void 0),ut([it({type:Array})],vt.prototype,"tickValues",void 0),ut([
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
function(t,i){return(({finisher:t,descriptor:i})=>(e,s)=>{var n;if(void 0===s){const s=null!==(n=e.originalKey)&&void 0!==n?n:e.key,o=null!=i?{kind:"method",placement:"prototype",key:s,descriptor:i(e.key)}:{...e,key:s};return null!=t&&(o.finisher=function(i){t(i,s)}),o}{const n=e.constructor;void 0!==i&&Object.defineProperty(e,s,i(s)),null==t||t(n,s)}})({descriptor:e=>{const s={get(){var i,e;return null!==(e=null===(i=this.renderRoot)||void 0===i?void 0:i.querySelector(t))&&void 0!==e?e:null},enumerable:!0,configurable:!0};if(i){const i="symbol"==typeof e?Symbol():"__"+e;s.get=function(){var e,s;return void 0===this[i]&&(this[i]=null!==(s=null===(e=this.renderRoot)||void 0===e?void 0:e.querySelector(t))&&void 0!==s?s:null),this[i]}}return s}})}("svg")],vt.prototype,"svg",void 0),ut([it({attribute:!1})],vt.prototype,"interpolator",null),ut([it({attribute:!1})],vt.prototype,"tickFormatter",null),vt=ut([(t=>i=>"function"==typeof i?((t,i)=>(window.customElements.define(t,i),i))(t,i):((t,i)=>{const{kind:e,elements:s}=i;return{kind:e,elements:s,finisher(i){window.customElements.define(t,i)}}})(t,i))("color-legend")],vt);export{vt as ColorLegendElement};
